                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="pt-1 mb-0 text-light">Create Supplier</h4>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="supplier_company" class="form-control @error('supplier_company') is-invalid @enderror" value="{{ old('supplier_company') }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="supplier_city" class="form-control @error('supplier_city') is-invalid @enderror" value="{{ old('supplier_city') }}">
                                            @error('supplier_city')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="supplier_state" class="form-control @error('supplier_state') is-invalid @enderror" value="{{ old('supplier_state') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="email" name="supplier_email" placeholder="example@example.com"
                                                class="form-control @error('supplier_email') is-invalid @enderror" value="{{ old('supplier_email') }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="supplier_address" placeholder=""
                                                class="form-control @error('supplier_address') is-invalid @enderror" value="{{ old('supplier_address') }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="number" name="supplier_postal" placeholder=""
                                                class="form-control @error('supplier_postal') is-invalid @enderror" value="{{ old('supplier_postal') }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="supplier_country" placeholder=""
                                                class="form-control @error('supplier_country') is-invalid @enderror" value="{{ old('supplier_country') }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="supplier_remarks" class="form-control @error('supplier_remarks') is-invalid @enderror" value="{{ old('supplier_remarks') }}">

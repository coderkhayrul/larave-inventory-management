                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="card-text pt-1 mb-0 text-light">All Biller List</h4>
                            <a href="{{ route('biller.create') }}" class="btn btn-primary"><i
                                    class="bx bx-plus-medical"></i> Add Biller</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th rowspan="1" colspan="1" style="width: 108px;">Company</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $data['biller_name'] }}</td>
                                                    <td>{{ $data['biller_phone'] }}</td>
                                                    <td>{{ $data['biller_email'] }}</td>
                                                    <td>{{ $data['biller_company'] }}</td>
                                                    <td>{{ $data['biller_address'] }}</td>
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item text-primary btn-link"
                                                                    href="{{ route('biller.show',$data->biller_slug) }}">
                                                                    <i class="dripicons-preview"></i> Show</a>
                                                                <a class="dropdown-item text-primary btn-link"
                                                                    href="{{ route('biller.edit',$data->biller_slug) }}">
                                                                    <i class="dripicons-document-edit"></i> Edit</a>

                                                                <a class="dropdown-item text-primary btn-link delete-modal"
                                                                    href="{{ route('biller.destroy',$data->biller_slug) }}"
                                                                    data-bs-toggle="modal"
                                                                    data-value="{{ $data->biller_id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('biller.destroy', $data->biller_slug) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')

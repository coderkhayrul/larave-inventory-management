                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="card-text pt-1 mb-0 text-light">All Department</h4>
                            <a href="{{ route('department.create') }}" class="btn btn-primary"><i
                                    class="bx bx-plus-medical"></i> Add Department</a>
                        </div>
                        <div class="card-body">
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item text-primary btn-link"
                                                                    href="{{ route('department.edit',$data->department_slug) }}">
                                                                    <i class="dripicons-document-edit"></i> Edit</a>

                                                                <a class="dropdown-item text-primary btn-link delete-modal"
                                                                    href="{{ route('department.destroy',$data->department_slug) }}"
                                                                    data-bs-toggle="modal"
                                                                    data-value="{{ $data->department_id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('department.destroy', $data->department_slug) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')

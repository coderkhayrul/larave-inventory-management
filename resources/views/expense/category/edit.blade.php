                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="pt-1 mb-0 text-light">Edit Expense Category</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('expense.category.update', $data->expcate_slug) }}">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="expcate_id" value="{{ $data->expcate_id}}"/>
                                <div class="row d-flex justify-content-center">
                                    <div class="col-md-6">
                                        <div class="form-group pb-2">
                                            <label><strong>Code <span class="text-danger">*</span></strong> </label>
                                            <div class="input-group mb-3">
                                                <input type="text" id="code_output" name="expcate_code" class="form-control @error('expcate_code') is-invalid @enderror" value="{{ $data->expcate_code }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="expcate_name" value="{{ $data->expcate_name }}" class="form-control @error('expcate_name') is-invalid @enderror" value="{{ old('expcate_name') }}">
                                            @error('expcate_name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <textarea class="form-control" name="expcate_remarks" @error('expcate_remarks') is-invalid @enderror>{{ $data->expcate_remarks }}</textarea>

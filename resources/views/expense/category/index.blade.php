                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="card-text pt-1 mb-0 text-light">All Expense Category</h4>
                            <a href="{{ route('expense.category.create') }}" class="btn btn-primary"><i
                                    class="bx bx-plus-medical"></i> Add Expense Category</a>
                        </div>
                        <div class="card-body">
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item text-primary btn-link"
                                                                    href="{{ route('expense.category.edit',$data->expcate_slug) }}">
                                                                    <i class="dripicons-document-edit"></i> Edit</a>

                                                                <a class="dropdown-item text-primary btn-link delete-modal"
                                                                    href="{{ route('expense.category.destroy',$data->expcate_slug) }}"
                                                                    data-bs-toggle="modal"
                                                                    data-value="{{ $data->expcate_id }}"

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="card-text pt-1 mb-0 text-light">All Product Category List</h4>
                            <a href="{{ route('product.category.create') }}" class="btn btn-primary"><i
                                    class="bx bx-plus-medical"></i> Add Product Category</a>
                        </div>
                        <div class="card-body">
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item text-primary btn-link"
                                                                    ...
                                                                    href="{{ route('product.category.destroy',$data->pc_slug) }}"
                                                                    data-bs-toggle="modal"
                                                                    data-value="{{ $data->pc_id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('product.category.destroy', $data->pc_slug) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')

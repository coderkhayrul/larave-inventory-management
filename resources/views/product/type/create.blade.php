                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="pt-1 mb-0 text-light">Create Product Type</h4>
                                ...
                                <div class="row d-flex justify-content-center">
                                    <div class="col-md-6">
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="pt_name" class="form-control @error('pt_name') is-invalid @enderror" value="{{ old('pt_name') }}">
                                            @error('pt_name')
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="pt_remarks" class="form-control @error('pt_remarks') is-invalid @enderror" value="{{ old('pt_remarks') }}">
                                            @error('pt_remarks')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="pt-1 mb-0 text-light">Edit Customer Group</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('customer.group.update',$data->cg_slug) }}">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <textarea name="cg_remarks" id="textarea" class="form-control"
                                                maxlength="225" rows="3" placeholder="Enter Your Remarks">{{ $data->cg_remarks }}</textarea>
                                            @error('cg_remarks')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="pt-1 mb-0 text-light">Create Purchase Unit</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('purchase.unit.store') }}">
                                @csrf
                                <div class="row d-flex justify-content-center">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <textarea class="form-control" name="pu_remarks" @error('pu_remarks') is-invalid @enderror></textarea>
                                            @error('pu_remarks')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>

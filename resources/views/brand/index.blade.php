                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="card-text pt-1 mb-0 text-light">All Brand List</h4>
                            <a href="{{ route('brand.create') }}" class="btn btn-primary"><i
                                    class="bx bx-plus-medical"></i> Add Brand</a>
                        </div>
                        <div class="card-body">
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item text-primary btn-link"
                                                                    href="{{ route('brand.edit',$data->brand_slug) }}">
                                                                    <i class="dripicons-document-edit"></i> Edit</a>

                                                                <a class="dropdown-item text-primary btn-link delete-modal"
                                                                    href="{{ route('brand.destroy',$data->brand_slug) }}"
                                                                    data-bs-toggle="modal"
                                                                    data-value="{{ $data->brand_id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('brand.destroy', $data->brand_slug) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')

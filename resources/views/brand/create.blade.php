                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="pt-1 mb-0 text-light">Create Brand</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group pb-2">
                                            ...
                                            <input id="user-fileinput" type="file" name="brand_image"
                                                class="form-control @error('brand_image') is-invalid @enderror" value="{{ old('brand_image') }}">
                                            @error('brand_image')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>

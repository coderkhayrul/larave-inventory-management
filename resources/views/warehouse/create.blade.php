                                ...
                                <div class="row d-flex justify-content-center">
                                    <div class="col-md-6">
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="wh_name" class="form-control @error('wh_name') is-invalid @enderror" value="{{ old('wh_name') }}">
                                            @error('wh_name')
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="wh_phone" class="form-control @error('wh_phone') is-invalid @enderror" value="{{ old('wh_phone') }}">
                                            @error('wh_phone')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="email" name="wh_email" class="form-control @error('wh_email') is-invalid @enderror" value="{{ old('wh_email') }}">
                                            @error('wh_email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <textarea class="form-control" name="wh_address" @error('wh_address') is-invalid @enderror></textarea>
                                            @error('wh_address')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>

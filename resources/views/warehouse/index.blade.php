                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="card-text pt-1 mb-0 text-light">All WareHouse</h4>
                            <a href="{{ route('warehouse.create') }}" class="btn btn-primary"><i
                                    class="bx bx-plus-medical"></i> Add WareHouse</a>
                        </div>
                        <div class="card-body">
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item text-primary btn-link"
                                                                    href="{{ route('warehouse.edit',$data->wh_slug) }}">
                                                                    <i class="dripicons-document-edit"></i> Edit</a>

                                                                <a class="dropdown-item text-primary btn-link delete-modal"
                                                                    href="{{ route('warehouse.destroy',$data->wh_slug) }}"
                                                                    data-bs-toggle="modal"
                                                                    data-value="{{ $data->wh_id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('warehouse.destroy', $data->wh_slug) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')

                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="customer_company" class="form-control @error('customer_company') is-invalid @enderror" value="{{ old('customer_company') }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="customer_state" class="form-control @error('customer_state') is-invalid @enderror" value="{{ old('customer_state') }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="customer_remarks" class="form-control @error('customer_remarks') is-invalid @enderror" value="{{ old('customer_remarks') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="customer_address" placeholder=""
                                                class="form-control @error('customer_address') is-invalid @enderror" value="{{ old('customer_address') }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="number" name="customer_postal" placeholder=""
                                                class="form-control @error('customer_postal') is-invalid @enderror" value="{{ old('customer_postal') }}">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <input type="text" name="customer_country" placeholder=""
                                                class="form-control @error('customer_country') is-invalid @enderror" value="{{ old('customer_country') }}">

                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group pb-2">
                                            ...
                                            <input disabled type="text" name="customer_name" class="form-control" value="{{ $customer->customer_name }}">
                                        </div>
                                        <div class="form-group pb-2">
                                            <label><strong>Company Name <span class="text-danger">*</span></strong> </label>
                                            <div class="input-group">
                                                <input disabled type="text" name="customer_company" class="form-control" value="{{ $customer->customer_company }}">
                                            </div>
                                        </div>
                                        <div class="form-group pb-2">
                                            <label><strong>Phone Number <span class="text-danger">*</span></strong></label>
                                            <input disabled type="text" name="customer_phone" class="form-control" value="{{ $customer->customer_phone }}">
                                        </div>
                                        <div class="form-group pb-2">
                                            <label><strong>City </strong></label>
                                            <input disabled type="text" name="customer_city" class="form-control" value="{{ $customer->customer_city }}">
                                        </div>
                                        <div class="form-group pb-2">
                                            <label><strong>State</strong></label>
                                            <input disabled type="text" name="customer_state" class="form-control" value="{{ $customer->customer_state }}">
                                        </div>
                                        <div class="form-group pb-2">
                                            <label><strong>Remarks <span class="text-danger">*</span></strong></label>
                                            <input disabled type="text" name="customer_remarks" class="form-control" value="{{ $customer->customer_remarks }}">
                                        </div>
                                    </div>
                                    {{-- Part  --}}
                                    <div class="col-md-6">
                                        <div class="form-group pb-2">
                                            ...
                                            <input disabled type="email" name="customer_email" placeholder="example@example.com"
                                                class="form-control" value="{{ $customer->customer_email }}">
                                        </div>
                                        <div class="form-group pb-2">

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark d-flex justify-content-between">
                            <h4 class="pt-1 mb-0 text-light">Create Sell Unit</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('sell.unit.store') }}">
                                @csrf
                                <div class="row d-flex justify-content-center">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <textarea class="form-control" name="su_remarks" @error('su_remarks') is-invalid @enderror></textarea>
                                            @error('su_remarks')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group pb-2">
                                            ...
                                            <select class="form-select @error('pu_id') is-invalid @enderror" value="{{ old('pu_id') }}" name="pu_id">
                                                ...
                                                @foreach ($pu_all as $data)

                                                <option title="{{ $data->pu_name}}" value="{{ $data->pu_id }}">{{ $data->pu_name }}</option>
                                                @endforeach
                                            </select>
                                            @error('pu_id')
                                                <div class="invalid-feedback">
